...
module.exports = class Classes {
    ...
    constructor({utils, cache, config, cortex, managers, validators, mongomodels} = {}) {
        ...
        this.httpExposed = ['makeClass', 'get=getClasses', 'put=assignStudentsToClass', 'delete=deleteClass'];
    }

    /**
     * @api {POST} /classes/makeClass make a Class
     * @apiName makeClass
     * @apiGroup Classes
     *
     * @apiDescription make a new class for students in db.
     *
     * @apiParam {Object} params - Parameters for class creation.
     * @apiParam {Object} params.__shortToken - User authorization token.
     * @apiParam {string} body.class_name - Name of the class.
     ...
     */
    async makeClass({__shortToken, className, students, school}) {
        ...
        const newClass = {class_name, students, school};

        let result = await this.validators.class.buildClass({
            ...newClass
        });
    ...
    /**
     * @api {GET} /classes/getClasses Get All scholl's classes
     * @apiName GetClasses
     * @apiGroup Classes
     *
