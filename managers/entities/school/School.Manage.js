...
module.exports = class School {
    ...
    constructor({utils, cache, config, cortex, managers, validators, mongomodels} = {}) {
        ...
        this.httpExposed = ['developSchool', 'get=getSchools', 'put=assignClassesToSchool', 'get=getSchool', 'delete=deleteSchool'];
    }

    /**
     * @api {POST} /schools/developSchool develop a School
     * @apiName developSchool
     * @apiGroup Schools
     *
    ...
    async developSchool({ __shortToken,school_name, classes,}) {
    ...
    /**
     * @api {GET} /schools/getSchools Get All Schools
     * @apiName getSchools
     * @apiGroup Schools
     *
