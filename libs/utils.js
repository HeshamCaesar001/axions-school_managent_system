const slugify = (text)=>{ //This function takes a text string and converts it into a "slug" format suitable for URLs
...
*/
const getDeepValue = (path, obj) => { //This function retrieves a nested value from an object based on a provided path string
